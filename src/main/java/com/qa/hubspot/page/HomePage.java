...
public class HomePage extends BasePage {
	...
	By loggedindropdown=By.xpath("//*[@id=\"account-menu\"]");
	By loggedinaccountname=By.xpath("//*[@id=\"userPreferences\"]/div[1]/div[1]");
	...
	public String getLoggedInUserAccountName() {
		elementUtil.doIsDisplayed(loggedindropdown);
		elementUtil.doClick(loggedindropdown);
